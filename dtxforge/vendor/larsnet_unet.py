"""Vendored from LarsNet (https://github.com/polimi-ispl/larsnet), file unet.py.

Upstream authors: A. I. Mezza, R. Giampiccolo, A. Bernardini, A. Sarti (Politecnico
di Milano, ISPL). Paper: "Toward deep drum source separation", Pattern Recognition
...
class UNetWaveform(UNet):
    """UNet that accepts a time-domain signal, computes the STFT, runs the UNet, and
    inverts back to the time domain."""
