@echo off
REM DTXScribe - start the local server, wait until it's ready, then open the browser.
...
start "DTXScribe server" cmd /c "python app.py"

echo Starting DTXScribe... (importing libraries, this can take 15-30 seconds)
...
echo.
echo DTXScribe is running. Close the "DTXScribe server" window to stop it.
